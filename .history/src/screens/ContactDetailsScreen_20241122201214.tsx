...
import { useImagePicker } from '../hooks/imagePickerUtils'; // Importa el hook useImagePicker
...
const ContactDetailsScreen: React.FC<ContactDetailsScreenProps> = ({ route }) => {
  ...
  const { photo, selectImageFromLibrary, takePhoto } = useImagePicker(); // Usa el hook para manejar la foto
  ...
  return (
    <View style={styles.container}>
      <Image source={{ uri: photo || contact.photo || 'https://via.placeholder.com/100' }} style={styles.image} />
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            {/* Contenedor de botones de la cámara y la galería */}
...
const styles = StyleSheet.create({
  ...
  buttonsContainer: {
    flexDirection: 'row', // Establece los botones en fila
  ...
  button: {
    ...
    padding: 10,
    alignItems: 'center',
    width: '48%', // Ocupa el 48% del ancho para cada botón
  },
  buttonText: {
    color: '#fff',
    fontWeight: 'bold',
