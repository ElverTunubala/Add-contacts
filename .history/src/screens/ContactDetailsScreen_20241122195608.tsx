...
import { selectImageFromLibrary, takePhoto } from '../hooks/imagePickerUtils'; 
import { useImagePicker } from '../hooks/imagePickerUtils';
...
const ContactDetailsScreen: React.FC<ContactDetailsScreenProps> = ({ route }) => {
  ...
  return (
    <View style={styles.container}>
      <Image source={{ uri: photo || 'https://via.placeholder.com/100' }} style={styles.image} />
